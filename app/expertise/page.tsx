...
function ExpertiseContent() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-3 py-8 sm:px-4 sm:py-12 md:px-10 md:py-16">
      ...
      <section className="mb-20 grid grid-cols-1 gap-8 md:grid-cols-3">
        {[
          ...
          <motion.div
            ...
            className="rounded-xl border-2 border-tech-border bg-tech-bg p-8 shadow-hard"
          >
      ...
      <section className="mb-20 grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div className="rounded-xl border-2 border-tech-border bg-tech-bg p-8 shadow-hard">
          ...
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {domains.map((d) => (
              <div key={d} className="rounded-xl border-2 border-tech-border bg-tech-surface px-4 py-3 font-mono text-[11px] font-bold uppercase text-tech-text">
                {d}
              </div>
            ))}
          </div>
        ...
        <div className="rounded-xl border-2 border-tech-border bg-tech-bg p-8 shadow-hard">
          <h2 className="font-display text-3xl font-black uppercase tracking-tight text-tech-text">
            {t("expDeliverTitle")}
          </h2>
      ...
      <section className="mb-20 grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div className="rounded-xl border-2 border-tech-border bg-tech-bg p-8 shadow-hard">
          <h3 className="font-display text-2xl font-black uppercase tracking-tight text-tech-text">{t("expMethodTitle")}</h3>
          ...
          <div className="mt-6 space-y-3">
            {methodLines.map((line, idx) => (
              <motion.div
                ...
                className="rounded-xl border-2 border-tech-border bg-tech-surface px-4 py-3 font-mono text-[11px] font-bold uppercase text-tech-text"
              >
                {line}
              </motion.div>
            ))}
        ...
        <div className="rounded-xl border-2 border-tech-border bg-tech-bg p-8 shadow-hard">
          ...
          <div className="mt-5 grid grid-cols-2 gap-3">
            {sectors.map((sector) => (
              <div
                key={sector}
                className="rounded-xl border-2 border-tech-border bg-tech-surface px-3 py-2 text-xs font-bold uppercase tracking-wide text-tech-text"
              >
                {sector}
              </div>
            ))}
          </div>
          <p className="mt-5 text-sm font-medium text-tech-text/75">
            {t("expSectorsFoot")}
          </p>
        </div>
      </section>

      <section className="mb-20 rounded-xl border-2 border-tech-border bg-tech-bg p-8 shadow-hard md:p-10">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {kpi.map((row) => (
            <div key={row.label} className="rounded-xl border-2 border-tech-border bg-tech-surface p-5 shadow-hard-sm">
